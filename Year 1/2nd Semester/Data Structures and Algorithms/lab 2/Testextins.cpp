...
void testresize() {
	Matrice matrice(1, 1);
	//matrice.add_elem({ {1, 1}, 2 });
	//matrice.resize();
	matrice.add_elem({ {1, 0}, 3 });
	matrice.add_elem({ {1, 0}, 4 });
	int cap = matrice.mcapacitate();
	assert(cap == 4);
	/*matrice.add_elem({ {1, 0}, 3 });
	matrice.add_elem({ {1, 0}, 4 });
	matrice.add_elem({ {1, 0}, 5 });
	int cap2 = matrice.nrLinii() * matrice.nrColoane();
	assert(cap2 == 16);*/
}
