...
void testCeaMaiFreqCheie(Relatie r) {
	MDO d = MDO(r);
	...
	// Verificăm dacă ceaMaiFreqCheie returnează cheia corectă
	TCheie freqCheie = d.ceaMaiFreqCheie();
	assert(freqCheie == 3);  // Cheia 3 apare de 4 ori
