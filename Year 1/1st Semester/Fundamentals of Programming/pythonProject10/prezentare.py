    ...
    while True:
        ...
        if option == '1':
            ...
            if optiune == '1':
                ...
                print(infrastructura.adauga_nr_complex(lista, parte_z, parte_i))
            elif optiune == '2':
                infrastructura.copie(lista)
                parte_z = int(input("parte reala: "))
                parte_i = int(input("parte imaginara: "))
                poz = int(input("pozitia: "))
                print(infrastructura.adauga_pe_poz(lista, parte_z, parte_i, poz))
            elif optiune == '3':
                return start()
        elif option == '2':
            meniu2()
            ...
            if optiune == '1':
                infrastructura.copie(lista)
                poz = int(input("pozitia: "))
                print(infrastructura.sterge_depe_poz(lista, poz))
            elif optiune == '2':
                infrastructura.copie(lista)
                poz1 = int(input("pozitia de inceput: "))
                poz2 = int(input("pozitia de sfarsit: "))
                print(business.sterg_interval(lista, poz1, poz2))
            elif optiune == '3':
                infrastructura.copie(lista)
                ...
                print(infrastructura.inlocuire_nr_complex(lista, pz, pi, parte_z, parte_i))
            elif optiune == '4':
                return start()
        elif option == '3':
            meniu3()
            ...
            if optiune == '1':
                ...
                poz2 = int(input("pozitia de sfarsit: "))
                print(infrastructura.tipareste_pi(lista, poz1, poz2, lista2))
            elif optiune == '2':
                lista3 = []
                print(business.modul_numar_maimic(lista, lista3))
            elif optiune == '3':
                lista4 = []
                print(business.modul_numar_egal(lista, lista4))
            elif optiune == '4':
                return start()
        elif option == '4':
            meniu4()
            ...
            if optiune == '1':
                poz1 = int(input("pozitiade inceput: "))
                poz2 = int(input("pozitia de sfarsit: "))
                print(business.suma_subsecventa(lista, poz1, poz2))
            elif optiune == '2':
                poz1 = int(input("pozitiade inceput: "))
                poz2 = int(input("pozitia de sfarsit: "))
                print(business.prod_subsecventa(lista, poz1, poz2))
            elif optiune == '3':
                print(infrastructura.sorteaza_descrescator(lista))
            elif optiune == '4':
                return start()
        elif option == '5':
            meniu5()
            ...
            if optiune == '1':
                infrastructura.copie(lista)
                print(business.filtrare_prime(lista))
            elif optiune == '2':
                infrastructura.copie(lista)
                numar_comp = float(input("numar cu care se compara: "))
                semn = str(input("semnul: "))
                print(business.filtrare_modul(lista, semn, numar_comp))
            elif optiune == '3':
                return start()
        elif option == '6':
            meniu6()
