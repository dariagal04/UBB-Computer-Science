...
def test_sterge_interval():
    assert business.sterg_interval([domeniu.creeaza_nrcomplex(1,2), domeniu.creeaza_nrcomplex(3,4), domeniu.creeaza_nrcomplex(5,6),domeniu.creeaza_nrcomplex(7,8)], 1, 2) == [domeniu.creeaza_nrcomplex(1,2), domeniu.creeaza_nrcomplex(7,8)]
...
def test_tipareste_pi():
    assert infrastructura.tipareste_pi([domeniu.creeaza_nrcomplex(1,2), domeniu.creeaza_nrcomplex(3,4), domeniu.creeaza_nrcomplex(5,6),domeniu.creeaza_nrcomplex(7,8)], 1, 3, []) == domeniu.creeaza_nrcomplex(4,6)
...
def test_suma_subsecventa():
    assert infrastructura.suma_subsecventa([domeniu.creeaza_nrcomplex(1,2), domeniu.creeaza_nrcomplex(3,4), domeniu.creeaza_nrcomplex(5,6),domeniu.creeaza_nrcomplex(7,8)], 1, 3) == domeniu.creeaza_nrcomplex(8,10)


def test_prod_subsecventa():
    assert infrastructura.prod_subsecventa([domeniu.creeaza_nrcomplex(1,2), domeniu.creeaza_nrcomplex(3,4), domeniu.creeaza_nrcomplex(5,6),domeniu.creeaza_nrcomplex(7,8)], 1, 3) == domeniu.creeaza_nrcomplex(15,24)


def test_sorteaza_descrescator():
    assert infrastructura.sorteaza_descrescator([domeniu.creeaza_nrcomplex(1,2), domeniu.creeaza_nrcomplex(3,4), domeniu.creeaza_nrcomplex(5,6),domeniu.creeaza_nrcomplex(7,8)]) == [domeniu.creeaza_nrcomplex(7,8), domeniu.creeaza_nrcomplex(5,6), domeniu.creeaza_nrcomplex(4,3),domeniu.creeaza_nrcomplex(1,2)]
