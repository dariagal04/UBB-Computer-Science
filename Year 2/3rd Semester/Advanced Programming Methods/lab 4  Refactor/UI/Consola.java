...
import org.example.Retea.Communities;
...
public class Consola {
    ...
    void addUtilizator() {
        ...
        try {
            network.addUtilizator(new Utilizator(firstName, lastName));
    ...
    void showFriendships() {
        ...
        for (Utilizator utilizator : network.getUtilizatori()) {
            System.out.println(utilizator.getFirstName() + " " + utilizator.getLastName() + " with Friends:" + utilizator.getPrieteni().size());
